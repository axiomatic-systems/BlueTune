...
#define BLT_PLUGIN_LOADER_FLAGS_SEARCH_WORKING_DIRECTORY   1
#define BLT_PLUGIN_LOADER_FLAGS_SEARCH_DEFAULT_DIRECTORIES 2
#define BLT_PLUGIN_LOADER_FLAGS_SEARCH_SPECIAL_NAMES       4
